...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<activesupport>, "= 6.1.3.2")
      s.add_development_dependency(%q<actionpack>, "= 6.1.3.2")
      ...
      s.add_dependency(%q<activesupport>, "= 6.1.3.2")
      s.add_dependency(%q<actionpack>, "= 6.1.3.2")
